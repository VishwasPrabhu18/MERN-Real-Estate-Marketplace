...
const Profile = () => {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p className="text-red-700 mt-5">{showListingError ? "Error showing Lsiting" : ""}</p>
        ...
        <div className="flex flex-col gap-4">
            <h1 className="text-center mt-7 text-2xl font-semibold">Your Listings</h1>
            {
              userListing.map((listing, index) => (
                ...
                <div key={index} className="flex justify-between items-center gap-4 border p-3 rounded-lg">
