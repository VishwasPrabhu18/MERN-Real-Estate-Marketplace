        ...
        <main className="p-3 max-w-4xl mx-auto">
            ...
            <form className="flex flex-col sm:flex-row gap-4">
                <div className="flex flex-col gap-4 flex-1">
                    <input type="text" placeholder="Enter the Name" className="border p-3 rounded-lg" id="name" maxLength={62} minLength={10} required />
                    <textarea type="text" placeholder="Enter the Description" className="border p-3 rounded-lg" id="description" required />
                    <input type="text" placeholder="Enter the Address" className="border p-3 rounded-lg" id="address" required />
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button className="mt-4 p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">Create Listing</button>
                </div>
            </form>
        </main>
    )
