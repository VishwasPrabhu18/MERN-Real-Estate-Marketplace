      ...
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div className="flex items-center gap-2">
            ...
            <input value={sideBarData.searchTerm} onChange={handleChange} type="text" name="searchTerm" id="searchTerm" placeholder="Search..." className="border rounded-lg p-3 w-full" />
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <select onChange={handleChange} defaultValue={"created_at_desc"} id="sort_order" className="border rounded-lg p-3">
              <option value="createdAr_desc">Latest</option>
              <option value="createdAr_asc">Oldest</option>
